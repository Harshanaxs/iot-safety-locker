...
<script>
import adminLayout from '@/components/userLayout.vue'
import Vue from "vue";
import {
  GridPlugin,
  Page,
        ...
        this.$refs.grid.pdfExport({
          ...
          header: {
            ...
            contents: [
              {
                type: "Text",
                value: "Smart Locker System Pvt Ltd",
                position: { x: 50, y: 50 },
                style: { textBrushColor: "#000000", fontSize: 20 },
              },
              {
                type: "Text",
                value: "Locker Allocation Report",
                position: { x: 50, y: 80 },
